    ...
    <el-card>
      ...
      >
        ...
        <el-table-column
          ...
          width="200px"
        ></el-table-column>
        <el-table-column label="商品数量" prop="address"></el-table-column>
        <el-table-column label="订单状态" prop="note"></el-table-column>
        <el-table-column label="订单类型" prop="note"></el-table-column>
        <el-table-column label="送货日期" prop="note"></el-table-column>
      ...
      >
        ...
        >
          ...
          <el-form-item label="省市区/县">
            <el-cascader
              :options="cityData"
              v-model="addClient.addressA.address1"
            >
            </el-cascader>
          </el-form-item>
      ...
      <!--            修改对话框-->
      <el-dialog title="修改客户" :visible.sync="editClientDialog" width="40%">
        <el-form
          :model="clientInfo"
          :rules="addClientRules"
          ref="editClientRef"
