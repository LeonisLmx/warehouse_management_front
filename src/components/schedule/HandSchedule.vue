...
export default {
  ...
  methods: {
    ...
    viewInfo(orderNum) {
        ...
        this.$http.get('/order/searchByOrderId?orderId=' + orderNum).then(res => {
            ...
            this.dataModel.operateName = this.operateOption.find(ans => ans.id == this.dataModel.operateId).name
        })
    }
  },
  created() {
